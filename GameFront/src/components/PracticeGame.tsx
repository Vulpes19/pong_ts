...
function PracticeGame({ powerUpGame }: prop) {
	...
	const handleMovement = useCallback((e: KeyboardEvent) => {
		if (e.key === "ArrowUp") send("UP", "movePlayer");
		if (e.key === "ArrowDown") send("DOWN", "movePlayer");
	}, []);
	...
	// 		// 	socket,
	// 		// 	(data) => {
	// 		// 		if (data == "leftPaddle") textures.paddle1Texture.src = "assets/big_paddle.png";
	// 		// 		else textures.paddle2Texture.src = "assets/big_paddle.png";
	...
	// 		// 	socket,
	// 		// 	(data) => {
	// 		// 		if (data == "leftPaddle") textures.paddle1Texture.src = "assets/small_paddle.png";
	// 		// 		else textures.paddle2Texture.src = "assets/big_paddle.png";
